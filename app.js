...
let intent = [
    ...
    { you: "hey", response: "How can I help you?" },
    {
        ...
        response: "My name is ChatBot, created by CH Muhammad Tayyab Gill.",
    },
    { you: "I love you", response: "I love you too! ❤️" },
    {
        you: "love",
        response: "Love is a good thing, but nowadays people often prioritize physical attraction and financial stability. ❤️",
    },
    {
        you: "Who created you?",
        response: "I was created by CH Muhammad Tayyab Gill with the help of TypeScript programming language.",
    },
    {
        you: "What can you do?",
        response: "I can answer your questions, provide information, and have a conversation with you.",
    },
    {
    ...
    },
    {
        ...
        response: "My purpose is to assist users like you with their queries and provide a helpful conversation.",
    },
    {
    ...
    },
    {
        ...
        response: "I'm a smart chatbot, but I'm still learning and improving my abilities.",
    },
    ...
    },
    {
        ...
        response: "That's great to hear! Do you have anything specific you'd like to talk about? 😊",
    },
    {
        you: "CH Muhammad Tayyab Gill",
        response: "He is a skilled developer who created a personal chatbot with the help of TypeScript programming language. He has a strong passion for AI and machine learning, and is always looking to improve his skills and create innovative projects.",
    }
];
...
async function mainMenu() {
    ...
    while (true) {
        ...
        if (result) {
            ...
            console.log(`Bot: I didn't understand. Please try again.`);
        }
    }
}
